...
const tests = [
  ...
  { text: "open vox", expect: { intent: "launch", slots: { project: "vox" } } },
  ...
  { text: "launch vox", expect: { intent: "launch", slots: { project: "vox" } } },
  { text: "fire up vox", expect: { intent: "launch", slots: { project: "vox" } } },
