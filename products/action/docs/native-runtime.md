...
Call native work through package.json scripts from `products/action`:
...
The scripts wrap helpers in [native/engine/scripts](native/engine/scripts). The most important wrappers are:
