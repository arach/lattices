...
const downloadUrl = "https://github.com/arach/action/releases/latest/download/Action.dmg";
    ...
    <div className="action-page">
      <nav className="nav action-nav" aria-label="Action navigation">
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            <a href="https://arach.github.io/action/agents/" className="nav-link action-nav-optional">For agents</a>
            <a href="https://github.com/arach/action" className="nav-link">Source</a>
            <ThemeToggle
              theme={theme}
              onToggle={() => setTheme(theme === "dark" ? "light" : "dark")}
            />
            <a href={downloadUrl} className="action-nav-download">Download</a>
          </div>
        </div>
      </nav>
      ...
      <main className="action-shell">
        <section className="action-hero" aria-labelledby="action-title">
          <div className="action-hero-copy fade-in">
            ...
            <div className="action-hero-actions">
              <a href={downloadUrl} className="hero-primary-cta action-primary-cta">
                Download Action
                <span aria-hidden="true">↓</span>
              </a>
              <a href="https://arach.github.io/action/agents/" className="hero-secondary-cta">
          ...
          <div className="action-receipt fade-in fade-in-delay-1" aria-label="Example Action run receipt">
        ...
        <section className="action-purpose" aria-labelledby="action-purpose-title">
          <div className="action-section-heading fade-in">
          ...
          <div className="action-product-boundary fade-in fade-in-delay-1">
            <article>
            ...
            <article>
              ...
              <a href={downloadUrl}>Download Action &rarr;</a>
            </article>
          </div>
        ...
        <section className="action-proof" aria-labelledby="action-proof-title">
          ...
          <div className="action-proof-lines fade-in fade-in-delay-1">
            <article>
              <span>01</span>
        ...
        <section className="action-final-cta fade-in" aria-labelledby="action-final-title">
          <div>
          ...
          <div className="action-final-links">
            <a href={downloadUrl} className="hero-primary-cta action-primary-cta">Download Action</a>
            <a href="https://github.com/arach/action" className="hero-secondary-cta">View source</a>
          </div>
        </section>
      </main>
      ...
      <footer className="action-footer">
        <div className="action-footer-inner">
          ...
          <div>
            <a href="/">Lattices</a>
            <a href="https://arach.github.io/action/">Action docs</a>
            <a href="https://github.com/arach/action">GitHub</a>
          </div>
        </div>
      </footer>
    </div>
